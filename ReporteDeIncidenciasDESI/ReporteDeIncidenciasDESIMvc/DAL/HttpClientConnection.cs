...
using ReporteDeIncidenciasDESIMvc.Helpers;
using ReporteDeIncidenciasDESIMvc.Models.Autentication;
using ReporteDeIncidenciasDESIMvc.Models.Common;
using System;
...
namespace ReporteDeIncidenciasDESIMvc.DAL
{
